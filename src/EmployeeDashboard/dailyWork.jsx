...
function DailyWork({
  ...
  const fetchEmployeeData = async () => {
    try {
      const response = await axios.get(
        `http://192.168.37.131:9090/api/ats/157industries/fetch-profile-details/${employeeId}/${userType}`
      );
    ...
    const saveLoginDetails = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          `http://192.168.37.131:9090/api/ats/157industries/save-daily-work/${employeeId}/${userType}`,
          formData
        );
  ...
  const fetchCurrentEmployerWorkId = async () => {
    try {
      const response = await axios.get(
        `http://192.168.37.131:9090/api/ats/157industries/fetch-work-id/${employeeId}/${userType}`
      );
  ...
  const handleLogoutLocal = async () => {
    try {
      ...
      await axios.put(
        `http://192.168.37.131:9090/api/ats/157industries/update-daily-work/${fetchWorkId} `,
        formData
      );
