          ...
          <div className="piechart-legend-flex">
            <ul className="legend">
              ...
              <li className="legend-item">
                <span
                  className="legend-color"
                  style={{ backgroundColor: "rgba(54, 162, 235, 0.6)" }}
                ></span>{" "}
                Rejected
              </li>
              <li className="legend-item">
                <span
                  className="legend-color"
                  style={{ backgroundColor: "rgba(255, 206, 86, 0.6)" }}
                ></span>{" "}
                LineUp
              </li>
              <li className="legend-item">
            ...
            <div className="piechart-legend-flex">
              <ul className="legend">
                ...
                <li className="legend-item">
                  <span
                    className="legend-color"
                    style={{ backgroundColor: "rgba(255, 192, 203, 0.6)" }}
                  ></span>{" "}
                  Round 1
                </li>
                <li className="legend-item">
                ...
                <li className="legend-item">
                  <span
                    className="legend-color"
                    style={{ backgroundColor: "rgba(230, 230, 250, 0.6)" }}
                  ></span>{" "}
                  Round 3
                </li>
                <li className="legend-item">
                  <span
                    className="legend-color"
                    style={{ backgroundColor: "rgba(88, 165, 122, 0.6)" }}
                  ></span>{" "}
                  Round 4
                </li>
                <li className="legend-item">
                  <span
                    className="legend-color"
                    style={{ backgroundColor: "rgba(59, 48, 94, 0.6)" }}
                  ></span>{" "}
                  Round 5
                </li>
                <li className="legend-item">
                  <span
                    className="legend-color"
                    style={{ backgroundColor: "rgba(132, 175, 206, 0.6)" }}
                  ></span>{" "}
                  Round 6
                </li>
                <li className="legend-item">
                  <span
                    className="legend-color"
                    style={{ backgroundColor: "rgba(228, 112, 229, 0.6)" }}
                  ></span>{" "}
                  Yet To Schedule
                </li>
                <li className="legend-item">
                  <span
                    className="legend-color"
                    style={{ backgroundColor: "rgba(157, 33, 80, 0.6)" }}
                  ></span>{" "}
                  No Show
                </li>
              </ul>
