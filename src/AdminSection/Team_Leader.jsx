...
function Accesstable() {
  ...
  useEffect(() => {
    const fetchTeamLeaderNames = async () => {
      const response = await axios.get(
        `http://localhost:9090/api/ats/157industries/tl-namesIds/${selectedManager.managerId}`
      );
  ...
  const fetchRecruiterUnderTeamLeader = useCallback(async () => {
    const response = await axios.get(
      `http://localhost:9090/api/ats/157industries/employeeId-names/${selectedTeamLeader.teamLeaderId}`
    );
  ...
  const fetchColumnsNames = async () => {
    const response = await axios.get(
      `http://localhost:9090/api/ats/157industries/fetch-columns-names`
    );
  ...
  const fetchAssignedColumn = async (assigneID, assigneeJobRole) => {
    const response = await axios.get(
      `http://localhost:9090/api/ats/157industries/column-by-id/${assigneID}/${assigneeJobRole}`
    );
    ...
    try {
      if (selectedRecruiters.recruiterId != "") {
        response = await axios.post(
          `http://localhost:9090/api/ats/157industries/${selectedRecruiters.recruiterId}/${selectedRecruiters.recruiterJobRole}/assign-column`,
        ...
        response = await axios.post(
          `http://localhost:9090/api/ats/157industries/${selectedTeamLeader.teamLeaderId}/${selectedTeamLeader.teamLeaderJobRole}/assign-column`,
        ...
        response = await axios.post(
          `http://localhost:9090/api/ats/157industries/${selectedManager.managerId}/${selectedManager.managerJobRole}/assign-column`,
  ...
  const fetchAssignedColumnCount = async () => {
    const response = await axios.get(
      `http://localhost:9090/api/ats/157industries/column-category-counts/${employeeId}/${userType}`
    );
  ...
  const handleUpdateClick = async () => {
    try {
      const response = await axios.post(
        `http://localhost:9090/api/ats/157industries/${assignedColumnRecruiterUpdate.id}/${assignedColumnRecruiterUpdate.jobRole}/assign-column`,
