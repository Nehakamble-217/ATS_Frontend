...
const AfterSelection = ({
  ...
  const fetchCandidateData = async () => {
    try {
      const response = await fetch(
        `http://93.127.199.85:9090/api/ats/157industries/specific-data/${candidateId}`
      );
      if (!response.ok) {
  ...
  const fetchPerformaceId = async()=>{
    try {
      const performanceId = await axios.get(
        `http://93.127.199.85:9090/api/ats/157industries/fetch-performance-id/${candidateId}`
      );
  ...
  const fetchCandidateTableData = async () => {
    ...
    try {
      const response = await fetch(
        `http://93.127.199.85:9090/api/ats/157industries/fetch-after-selection?candidateId=${candidateId}&employeeId=${employeeId}&requirementId=${requirementId}`
      );
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
  ...
  const handleAdharCardUpload = async (e) => {
    ...
    try {
      ...
      const response1 = await axios.put(
        `http://93.127.199.85:9090/api/ats/157industries/update-performance/${performanceId}`,
        additionalData
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://93.127.199.85:9090/api/ats/157industries/add-after-selection",
        {
          method: "POST",
          headers: {
  ...
  const JoininghandleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://93.127.199.85:9090/api/ats/157industries/save-join-data",
        {
          method: "POST",
          body: formData,
        }
