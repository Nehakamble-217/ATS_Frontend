...
function CandidateVerification() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://192.168.1.42:8891/api/ats/157industries/verify${location.search}`);
    ...
    useEffect(() => {
        axios
            .get(
                `http://192.168.1.42:8891/api/ats/157industries/verify/${location.search.split("email=")[1]
                }`
            )
            .then((resolve) => {
                return resolve.data;
