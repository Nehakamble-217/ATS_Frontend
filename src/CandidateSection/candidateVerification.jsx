...
function CandidateVerification() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://93.127.199.85:9090/api/ats/157industries/verify${location.search}`);
    }, [location.search]);

    useEffect(() => {
        axios
            .get(
                `http://93.127.199.85:9090/api/ats/157industries/verify/${location.search.split("email=")[1]
                }`
            )
            .then((resolve) => {
                return resolve.data;
