...
//             <button className="callingList-filter-btn" onClick={toggleFilterSection}>Filter <i className="fa-solid fa-filter"></i></button>
//           </div>
...
const CallingList = ({ updateState, funForGettingCandidateId }) => {
  ...
  const limitedOptions = ['date', 'recruiterName', 'jobDesignation', 'requirementId' , 'sourceName', 'requirementCompany','selectYesOrNo'];
