...
<<<<<<< HEAD
        "http://192.168.1.38:8891/api/ats/157industries/add-employee",
=======
        "http://192.168.1.39:8891/api/ats/157industries/add-employee",
...
=======
        ...
        <div className="form-row">
          ...
          {!passwordError && passwordMatch && (
            <div className="success-message">Password is correct</div>
          )}
          {!passwordError && !passwordMatch && (
        ...
        <div className="form-row">
          ...
          <input
            type="text"
            name="inductionYesOrNo"
            placeholder="Enter Induction (Yes/No)"
            value={formData.inductionYesOrNo}
            onChange={handleInputChange}
          />
        </div>
        ...
        <div className="form-row">
          ...
          <input
            type="text"
            name="trainingCompletedYesOrNo"
            placeholder="Enter Training Completed (Yes/No)"
            value={formData.trainingCompletedYesOrNo}
            onChange={handleInputChange}
          />
        </div>
