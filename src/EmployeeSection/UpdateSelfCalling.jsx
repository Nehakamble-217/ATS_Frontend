...
const UpdateCallingTracker = ({ initialData, candidateId }) => {
  ...
  const fetchEmployeeName = async () => {
    try {
      const response = await fetch(
        `http://192.168.1.39:8891/api/ats/157industries/employeeName/${newCandidateId}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://192.168.1.39:8891/api/ats/157industries/update-callingData/${newCandidateId}`,
        {
          method: "POST",
          headers: {
          ...
          <table className="table text-center table-striped studTables">
            <tbody>
                  ...
                  >
                    ...
                    >
                      <label
                        ...
                        style={{ marginRight: "23px", width: "40px" }}
                      >
                        Months:
                      </label>
                      <input
              ...
              <tr>
                ...
                <th scope="col" style={{ textAlign: "left", color: "gray" }}>
                  Expected CTC (LPA)
                </th>
                <td style={{ display: "flex" }}>
                  <div
