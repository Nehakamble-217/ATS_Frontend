...
const LineupExcelData = ({
  ...
  useEffect(() => {
    fetch(
      `http://192.168.1.51:9090/api/ats/157industries/lineup-excel-data/${employeeId}`
    )
  ...
  const handleUpdateSuccess = () => {
    ...
    fetch(`http://192.168.1.51:9090/api/ats/157industries/lineup-excel-data/${employeeId}`)
      .then((response) => response.json())
      .then((data) => {
        setLineUpList(data);
        setFilteredLineUpList(data);
