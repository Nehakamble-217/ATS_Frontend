...
const ForgotPasswordForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    empName: '',
    emailId: '',
    jobRole: userType ? userType.charAt(0).toUpperCase() + userType.slice(1) : '',
    otp: '',
    password: '',
    confirmPassword: ''
  });
        ...
        <div className="space-y-4">
          ...
          {step === 1 && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-1">
              ...
              {error && <p className="text-red-500 text-sm mt-1 sm:col-span-2">{error}</p>}
              {message && <p className="text-green-500 text-sm mt-1 sm:col-span-2">{message}</p>}
            </div>
