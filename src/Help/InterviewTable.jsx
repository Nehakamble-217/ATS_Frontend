  ...
  const fetchAllData = async () => {
    try {
      ...
      const [detailsRes, yesRes, noRes, yetToBeConfirmedRes] = await Promise.all([
        axios.get('http://localhost:1414/api/interview/details'),
        axios.get('http://localhost:1414/api/interview/status/yes/All'),
        axios.get('http://localhost:1414/api/interview/status/no/All'),
        axios.get('http://localhost:1414/api/interview/status/yet-to-be-confirmed/All')
      ]);
